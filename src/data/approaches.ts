...
export const approaches: ApproachPage[] = [
  {
    ...
    imageAlt: '地上の研究と宇宙環境をつなぎ、新しい問いをつくる線画',
  ...
  },
  {
    ...
    lead: [
      '宇宙実験の方法は、一つではありません。',
      'ISSだけでなく、有人商業ステーション、無人回収型衛星、短期間の宇宙実験、長期間の軌道上実験など、研究者が利用できる宇宙環境は増えています。',
      '重要なのは、「宇宙へ行くこと」ではなく、',
    ],
    emphasis: '研究目的に最適な宇宙環境を選ぶことです。',
    image: '/images/space-project/approaches/02-access.webp',
    imageAlt: '複数の宇宙実験機会を比較し、最適なアクセス方法を選ぶ線画',
  ...
  },
  {
    ...
    imageAlt: '地上の研究装置を宇宙対応化し、共通実験基盤へ育てる線画',
  ...
  },
  {
    ...
    imageAlt: '宇宙で得たデータを地球の製品や社会の新しい価値へつなぐ線画',
