...
export const approaches: ApproachPage[] = [
  {
    ...
    image: '/images/space-project/approaches/01-research-theme-illustration.png',
    imageAlt: '研究者が地上の研究課題と宇宙環境をつなぎ、新しい研究テーマを考える図解イラスト',
  ...
  },
  {
    ...
    image: '/images/space-project/approaches/02-experiment-access-illustration.png',
    imageAlt: '複数の宇宙実験機会を比較し、研究に最適なアクセス方法を選ぶ図解イラスト',
  ...
  },
  {
    ...
    image: '/images/space-project/approaches/03-space-equipment-illustration.png',
    imageAlt: '地上の研究機器を宇宙対応の実験装置へ発展させる図解イラスト',
  ...
  },
  {
    ...
    image: '/images/space-project/approaches/04-value-standards-illustration.png',
    imageAlt: '宇宙で得たデータから地球の商品価値を見直す図解イラスト',
